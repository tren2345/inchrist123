export function initThemeToggle() {
  ...
  toggle.addEventListener('click', () => {
    ...
    if (isLight) {
      // Light to Dark
      rippleEffect.className = 'dark-ripple';
      setTimeout(() => {
